      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            ...
            <Button className="flex items-center gap-2 bg-limitless-teal hover:bg-limitless-teal/90">
              Read More Stories <ChevronRight size={16} />
            </Button>
          </div>
          <div className="order-1 lg:order-2">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-32 h-32 rounded-tl-3xl bg-limitless-lavender"></div>
              <img 
